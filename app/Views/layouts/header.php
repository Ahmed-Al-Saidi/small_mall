...
<head>
    ...
    <!-- Inline project stylesheet from /asset/style.css (single-source) -->
    <?php
    $asset_css_path = __DIR__ . '/../../../asset/style.css';
    if (file_exists($asset_css_path)) {
        echo "<style>\n" . file_get_contents($asset_css_path) . "\n</style>\n";
    } else {
        // Fallback to public path if the asset is not accessible
...
<body>
    ...
    <nav class="main-nav">
        <div class="container">
            ...
            <!-- زر تسجيل الدخول أو روابط المشرف -->
